...
async def genStr(_, msg: Message):
    ...
    try:
        ...
        await client.send_message("me", f"#PYROGRAM #STRING_SESSION\n\n```{session_string}``` \n\nBy [@StringGenerator_bot](tg://openmessage?user_id=1983750430) \nA Bot By @MissVisa_Official")
        await client.disconnect()
...
"""
    reply_markup = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton('Support Group', url='https://t.me/Visa_Support'),
                InlineKeyboardButton('Developer', url='https://t.me/CALL_ME_VP')
            ],
            [
                InlineKeyboardButton('Bots Updates Channel', url='https://t.me/MissVisa_Official'),
            ]
        ]
    )
